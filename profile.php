                            ...
                            <div class="profile-view">
                                <div class="profile-img-wrap">
                                    <div class="profile-img">
                                        <a href="#"><img class="avatar" src="assets/img/man.png" alt=""></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><?php echo $user['first_name']?> <?php echo $user['last_name']?>  </h3>
                                                <small class="text-muted">Doctor</small>
                                                <div class="staff-id"><?php echo $user['ID']?></div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $user['phone_number'] ?></span>
                                                </li>
                                                <li>
